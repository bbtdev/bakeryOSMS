<?php
  if (isset($_GET["CorecteazaDocument"])) {
    ...
    if (isset($_POST['sursa_items_corectie'])) {
      ...
      if ($sursa_items_corectie == 'catalog') {
        $operatiune = 'none';
        $label_txt_q_d = '';
        $label_txt_for_txt_inputs = 'Cantitate produs uitat:';
        $form_afisare = 'split';
        $items['produs_fabricat'] = getItemsFromCatalogForForm('produs_fabricat');
        if ($tip_intrari == 'produse_comercializate') {
          $items['ambalaj'] = getItemsFromCatalogForForm('ambalaj');
        }
        $items = splitItemsForForm($items);
      }
      else if ($sursa_items_corectie == 'document') {
        $operatiune = 'adunare';
        $allow_neg = 1;
      ...
      else if ($sursa_items_corectie == 'stoc') {
        $operatiune = 'scadere';
  ...
  if (isset($_POST["CreareCorectie"])) {
    ...
    //verificata integritatea stocului
    if (isset($_POST['sursa_items_corectie'])) {
      $sursa_items_corectie = $_POST['sursa_items_corectie'];
      if ($sursa_items_corectie == 'document') {
        foreach (array('produs_fabricat', 'ambalaj') as $catalog_denumire) {
          if (isset($_POST[$catalog_denumire . '_ids'])) {
            checkNoileAditiiDistrugIntegritateaStocului($document_de_corectat_istoric_id, $catalog_denumire, $_POST[$catalog_denumire . '_ids'], 
                                                            $_POST[$catalog_denumire . '_cantitati'], $_POST[$catalog_denumire . '_individual_item_ids']);   
          }
        }
      }
    }
    ...
    //end verifica integritate stocului
    ...
    if ($sursa_items_corectie == 'catalog') {
      foreach (array('produs_fabricat', 'ambalaj') as $catalog_denumire) {
        if (isset($_POST[$catalog_denumire . '_ids'])) {
          ...
          0, 0, $_POST[$catalog_denumire . '_explicatii']);
          //insertInTableTipDocumentProduse($tabel_nume, 11, $catalog_denumire, $_POST[$catalog_denumire . '_ids'], $_POST[$catalog_denumire . '_cantitati'], 0, $_POST[$catalog_denumire . '_explicatii']);
        }
      }
    }
    else if ($sursa_items_corectie == 'document') {
      foreach (array('produs_fabricat', 'ambalaj') as $catalog_denumire) {
        if (isset($_POST[$catalog_denumire . '_ids'])) {
          insertInTableTipDocumentCorectieProduse($tabel_nume, $catalog_denumire, $_POST[$catalog_denumire . '_ids'], $_POST[$catalog_denumire . '_cantitati'],
          $_POST[$catalog_denumire . '_individual_item_ids'], $_POST[$catalog_denumire . '_document_item_ids'], $_POST[$catalog_denumire . '_explicatii']);
        }
      }
    }
    else if ($sursa_items_corectie == 'stoc') {
      foreach (array('produs_fabricat', 'ambalaj') as $catalog_denumire) {
        if (isset($_POST[$catalog_denumire . '_ids'])) {
          insertInTableTipDocumentCorectieProduse($tabel_nume, $catalog_denumire, $_POST[$catalog_denumire . '_ids'], $_POST[$catalog_denumire . '_cantitati'],
          $_POST[$catalog_denumire . '_individual_item_ids'], 0, $_POST[$catalog_denumire . '_explicatii']);
        }
      }
    }
    else {
    ...
    if (isset($_POST['sursa_items_corectie'])) {
      ...
      if ($sursa_items_corectie == 'catalog') {
        ...
        foreach (array('produs_fabricat', 'ambalaj') as $catalog_denumire) {
          if (isset($_POST[$catalog_denumire . '_ids'])) {
            //insertInTableTipDocumentProduse($tabel_nume, 11, $catalog_denumire, $_POST[$catalog_denumire . '_ids'], $_POST[$catalog_denumire . '_cantitati'], 0, $_POST[$catalog_denumire . '_explicatii']);
            insertInTableTipDocumentCorectieProduse($tabel_nume, $catalog_denumire, $_POST[$catalog_denumire . '_ids'], $_POST[$catalog_denumire . '_cantitati'], 0, 0, $_POST[$catalog_denumire . '_explicatii']);
          }
        }
      }
      else if ($sursa_items_corectie == 'document') {
